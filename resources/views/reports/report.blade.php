                            ...
                            <table style="font-size: 8pt;" align="right">
                                ...
                                @foreach($report as $i)
                                    <tr>
                                        ...
                                        <td style="text-align:right">{{number_format((float) $i->total_mono_price, 2, '.', '')}}
                                            &nbsp;&nbsp;&nbsp;
                                        </td>
                                        <td style="text-align:right">{{number_format((float) $i->exchange_total, 2, '.', '')}}
                                            &nbsp;&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                <table style="font-size: 8pt; " align="right">
                                    ...
                                    @foreach($report as $i)
                                        <tr>
                                            ...
                                            <td style="text-align:right">{{number_format((float) $i->total_color_price, 2, '.', '')}}
                                                &nbsp;&nbsp;&nbsp;
                                            </td>
                                            <td style="text-align:right">{{number_format((float) $i->total_color_price, 2, '.', '')}}
                                                &nbsp;&nbsp;&nbsp;
