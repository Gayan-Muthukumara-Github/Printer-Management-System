            ...
            <div class="col-sm-12 mainbackground">
                <div class="row g-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            @foreach($report as $i)
                                <h3 style="font-size: 8pt; ">Branch Name : {{$i->branch}}</h3>
                                ...
                                <table style="font-size: 8pt;" align="right">
                                    ...
                                    <tr>
                                        <td>{{$i->printer_model}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{$i->no_of_units}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{$i->total_mono}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{$i->mono_value}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{number_format((float) $i->total_mono_price, 2, '.', '')}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{number_format((float) $i->exchange_total, 2, '.', '')}}&nbsp;&nbsp;&nbsp;</td>
                                    </tr>
                                </table>
                                <div class="col-md-12">
                                    <br>
                                ...
                                <table style="font-size: 8pt;" align="right">
                                    ...
                                    <tr>
                                        <td>{{$i->printer_model}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{$i->no_of_units}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{$i->total_color}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{$i->color_value}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{number_format((float) $i->total_color_price, 2, '.', '')}}&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align:right">{{number_format((float) $i->total_color_price, 2, '.', '')}}&nbsp;&nbsp;&nbsp;</td>
                                    </tr>
                                </table>
                                <div class="col-md-12">
